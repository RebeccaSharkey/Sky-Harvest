...
public class SCR_ShopPlayerSlotUI : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerMoveHandler
{
    ...
    public void OnClick()
    {
        ...
        CustomEvents.ShopSystem.OnOpenInspectionPlayer?.Invoke(_inventorySlot, false, _shopID);
    ...
    private void SellStack()
    {
        Destroy(_toolTip);
        _toolTip = null;
        CustomEvents.ShopSystem.OnAddNewItemStack?.Invoke(_inventorySlot.Item, stackTwo, _inventorySlot.Quality, _shopID);
        switch (_inventorySlot.Quality)
        {
            case ItemQuality.Bad:
    ...
    public void OnInspect()
    {
        ...
        CustomEvents.ShopSystem.OnOpenInspectionPlayer?.Invoke(_inventorySlot, true, _shopID);
        if (_inventorySlot.Item.ItemType == ItemTypes.crop)
        {
            CustomEvents.InventorySystem.OnShowCropPediaButtons?.Invoke((SCR_CropItems)_inventorySlot.Item, 1);
        }
